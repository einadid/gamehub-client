...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-200 shadow-lg px-4 sticky top-0 z-50 font-montserrat">
            <div className="navbar-start">
                ...
                <Link to="/" className="btn btn-ghost text-2xl font-bold font-orbitron">
                ...
                {user ? (
                    <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-200 rounded-box w-52">
                            ...
                            <li><Link to="/my-profile" className='justify-between'>My Profile</Link></li>
                            <li onClick={handleLogOut}><a>Logout</a></li>
                        </ul>
                    </div>
                ) : (
                    <Link to="/login" className="btn btn-outline btn-primary font-orbitron">Login</Link>
                )}
            </div>
        </div>
    );
